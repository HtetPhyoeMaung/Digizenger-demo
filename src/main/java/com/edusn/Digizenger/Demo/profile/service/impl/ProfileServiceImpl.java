...
import com.edusn.Digizenger.Demo.profile.dto.response.myProfile.UserProfileDto;
...
public class ProfileServiceImpl implements ProfileService {
    ...
    public ResponseEntity<Response> showUserProfile(HttpServletRequest request) {
        ...
        if(profile == null){
            ...
            newProfile.setProfileLinkUrl("http://localhost:8080/digizenger/api/v1/profile/"+randomString);
        ...
        if(profile.getUsername() != null){
            profile.setProfileLinkUrl("http://localhost:8080/digizenger/api/v1/profile/"+profile.getUsername());
        }

        /* If user's profile is existed, map existProfileDto and profile which existed */
